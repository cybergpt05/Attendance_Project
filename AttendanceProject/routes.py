...
from AttendanceProject.forms import StudentCoursesForm,ChangePasswordForm,DoctorAddStudent,AddUserForm,LoginForm,AddCourseForm,ManageCoursesForm,DoctorCoursesForm
...
def generate_qr(course_id):
    ...
    with open(static_folder+'file.txt','a') as file:
        file.write('1234567890')
    with open(static_folder+'file.txt','r') as file:
        content = file.read()
        print(content)
        print('\n\n\n')
